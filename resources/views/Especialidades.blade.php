          ...
          <div class="tab-pane fade active show" id="menu-starters">
            ...
            <div class="row gy-5">
              ...
              <div class="col-lg-4 menu-item">
                <a href="assets/img/menu/ravioli.jpg" class="glightbox"><img src="assets/img/menu/ravioli.jpg" class="menu-img img-fluid" alt=""></a>
                <h4>Ravioli</h4>
                <p class="ingredients">
                 Ravioli de langosta con salsa de azafrán
                </p>
                <p class="price">
                  $150
                </p>
              ...
              <div class="col-lg-4 menu-item">
                <a href="assets/img/menu/filete.jpg" class="glightbox"><img src="assets/img/menu/filete.jpg" class="menu-img img-fluid" alt=""></a>
                <h4>Filete</h4>
                <p class="ingredients">
                  Filete de ternera con costra de café y puré de batata al jengibre
                </p>
                <p class="price">
                  $199
                </p>
              ...
              <div class="col-lg-4 menu-item">
                <a href="assets/img/menu/salmon.jpg" class="glightbox"><img src="assets/img/menu/salmon.jpg" class="menu-img img-fluid" alt=""></a>
                <h4>Salmón</h4>
                <p class="ingredients">
                  Salmón glaseado con miso y puré de coliflor trufado
                </p>
                <p class="price">
                  $250
                </p>
              ...
              <div class="col-lg-4 menu-item">
                <a href="assets/img/menu/risotto.jpg" class="glightbox"><img src="assets/img/menu/risotto.jpg" class="menu-img img-fluid" alt=""></a>
                <h4>Risotto</h4>
                <p class="ingredients">
                 Risotto de hongos silvestres con trufas
                </p>
                <p class="price">
                  $299
                </p>
              ...
              <div class="col-lg-4 menu-item">
                <a href="assets/img/menu/pato.jpg" class="glightbox"><img src="assets/img/menu/pato.jpg" class="menu-img img-fluid" alt=""></a>
                <h4>Pato</h4>
                <p class="ingredients">
                  Pato confitado con salsa de cerezas y puré de chirivía
                </p>
                <p class="price">
                  $200
                </p>
              ...
              <div class="col-lg-4 menu-item">
                <a href="assets/img/menu/postre.jpg" class="glightbox"><img src="assets/img/menu/postre.jpg" class="menu-img img-fluid" alt=""></a>
                <h4>Soufflé</h4>
                <p class="ingredients">
                  Soufflé de queso de cabra con miel y nueces caramelizadas
                </p>
                <p class="price">
                  $100
                </p>
