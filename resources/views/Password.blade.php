...
<link href="assets/css/main.css" rel="stylesheet">
    ...
    <body class="sb-nav-fixed " style="background-color: #ECECEC;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form>
                                            ...
                                            <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                                <a class="small" href="/login">Volver al Inicio de Sesion</a>
                                                <button type="button" class="btn btn-danger" id="RecuperarPSW">Restablecer</button>
                                            </div>
                                        </form>
                                    </div>
        ...
        <script src="js/ControladorRPSW.js"></script>
