          ...
          <div class="tab-pane fade active show" id="menu-starters">
            ...
            <div class="row gy-5">
              ...
              <div class="col-lg-4 menu-item">
                <a href="assets/img/menu/Papas-1.png" class="glightbox"><img src="assets/img/menu/Papas-1.png" class="menu-img img-fluid" alt=""></a>
                <h4>Papas a la Francesa</h4>
                <p class="ingredients">
                  Calientitas y crujientes ¡hechas al momento!
                </p>
                <p class="price">
                  $54
                </p>
              ...
              <div class="col-lg-4 menu-item">
                <a href="assets/img/menu/Aros-de-cebolla-1.png" class="glightbox"><img src="assets/img/menu/Aros-de-cebolla-1.png" class="menu-img img-fluid" alt=""></a>
                <h4>Aros de Cebolla</h4>
                <p class="ingredients">
                  Delicioso sabor circular
                </p>
                <p class="price">
                  $49
                </p>
              ...
              <div class="col-lg-4 menu-item">
                <a href="assets/img/menu/papas-hashbrown-1.png" class="glightbox"><img src="assets/img/menu/papas-hashbrown-1.png" class="menu-img img-fluid" alt=""></a>
                <h4>Papas Hashbrown</h4>
                <p class="ingredients">
              ...
              <div class="col-lg-4 menu-item">
                ...
                <h4>Ensalada</h4>
                <p class="ingredients">
                 Lechuga, Cebolla, Zanahoria, Carne
                </p>
                <p class="price">
                  $40
                </p>
              ...
              <div class="col-lg-4 menu-item">
                ...
                <h4>Carne</h4>
                <p class="ingredients">
                  Arrachera con salsa y champiñones
                </p>
                <p class="price">
                  $60
                </p>
              ...
              <div class="col-lg-4 menu-item">
                ...
                <h4>Palitos de queso</h4>
                <p class="ingredients">
                  Palitos de queso y verduras
                </p>
                <p class="price">
                  $39
                </p>
