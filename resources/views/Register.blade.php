...
<html lang="en">   
  ...
  <!--SweatAlert-->
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.0/css/bootstrap.min.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-sweetalert/1.0.1/sweetalert.min.css">
    <link rel="stylesheet" type="text/php" href="assets/vendor/reCaptcha.php">
...
<link href="assets/css/main.css" rel="stylesheet">
    ...
    <body class="sb-nav-fixed" style="background-color: #ECECEC;">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form id="miFormulario" action="assets/vendor/reCaptcha.php" method="post">
                                            <div class="row mb-3">
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <input class="form-control" id="Nombre" type="text" placeholder="Enter your first name" />
                                                        <label for="Nombre">Nombre</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-floating">
                                                        <input class="form-control" id="Apellido" type="text" placeholder="Enter your last name" />
                                                        <label for="Apellido">Apellido</label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="Correo" type="email" placeholder="name@example.com" />
                                                <label for="Correo">Correo Electronico</label>
                                            </div>
                                            <div class="row mb-3">
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <input class="form-control" id="Contrasena" type="text" placeholder="Create a password" />
                                                        <label for="Contrasena">Contraseña</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <input class="form-control" id="Ccontrasena" type="text" placeholder="Confirm password" />
                                                        <label for="Ccontrasena">Confirmar Contraseña</label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="g-recaptcha" data-sitekey="6LcXipspAAAAAMin5oOQ2SE06ytyrs8cb9BkPMSw"></div>

                                            <div class="mt-4 mb-0">

                                               <div class="d-grid" ><button type="button" id="Register" class="btn btn-danger btn-block" value="Register" href="/">Crear Cuenta</button></div>
                                              <!--  <button type="button" id="Register" class="btn btn-danger btn-block" value="Registrar" href="index.html">Registrar</button>-->
                                            </div>
                                        </form>
                                    </div>
                                    <div class="card-footer text-center py-3">
                                        <div class="small"><a href="/login">Ya tienes una cuenta? Inicia Sesion</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script src="js/ControlRegistro.js"></script>
